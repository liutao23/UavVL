...
class build_transformer(nn.Module):
    def __init__(self, num_classes,block = 4 ,return_f=False,
                 pretrain_path=''):
...
class two_view_net(nn.Module):
    def __init__(self,class_num, block=4, return_f=False, pretrain_path=''):
        super(two_view_net, self).__init__()
        self.model_1 = build_transformer(class_num, block=block,return_f=return_f,pretrain_path=pretrain_path)
